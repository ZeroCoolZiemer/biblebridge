...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($siteName === '') {
        ...
        // Compute base URL before writing config so we can store it reliably.
        // This runs while SCRIPT_NAME still points to setup.php itself, which is
        // the most reliable moment to detect the install path.
        $baseUrl = rtrim(dirname($_SERVER['SCRIPT_NAME']), '/');
